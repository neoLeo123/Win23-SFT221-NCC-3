...
void runwhiteboxTests() {
    ...
    struct Shipment shipment1 = { 10, 1, {22, 'B'} };
    ...
    struct Shipment shipment2 = { 10, 1, {12, 'L'} };
    ...
    struct Shipment shipment3 = { 10, 1, {7, 'S'} };
    ...
    struct Shipment shipment4 = { 10, 1, {3, 'C'} };
    ...
    struct Shipment shipment5 = { 10, 1, {3, 'C'} };
    ...
    struct Shipment shipment6 = { 500, 1, {14, 'U'} };
...
void runblackboxTests() {
    ...
    struct Shipment shipment1 = { 500, 1, {14, 'U'} };
    ...
    struct Shipment shipment2 = { 500, 1, {13, 'U'} };
    printf("Test 2: Should return 0\n");
    int result2 = findTruckForShipment(&deliveryMap, Truck2, shipment2);
    printf("Result: %d\n\n", result2);
    ...
    struct Shipment shipment3 = { 500, 1, {13, 'U'} };
    ...
    struct Shipment shipment4 = { 500, 1, {13, 'U'} };
    ...
    struct Shipment shipment5 = { 500, 1, {13, 'U'} };
